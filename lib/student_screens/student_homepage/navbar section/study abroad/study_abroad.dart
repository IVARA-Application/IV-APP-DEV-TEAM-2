...
class StudyAbroadPage extends StatefulWidget {
  static String id = 'StudyAbroadPage';
  const StudyAbroadPage({Key key}) : super(key: key);

  @override
  _StudyAbroadPageState createState() => _StudyAbroadPageState();
}

class _StudyAbroadPageState extends State<StudyAbroadPage> {
